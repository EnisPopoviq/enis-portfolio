...
const skills = [
  ...
  { name: "Canva", level: 98, category: "Tools" },
];

 {/*We also need a list of categories which we don't have*/}

const categories = ["All", "Frontend", "Tools"];

export const Skills = () => {
// We want to make categories so we need to use useState()
  const [activeCategory, setActiveCategory] = useState("All");
// Now we also need to filter the categories
    ...
    {/*We want to make a list of 
     ...
     button for each category*/}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
         {/*INSTEAD OF MAPPING THROUGH THE SKILLS WE WANT TO MAP THROUGH THE FILTERED SKILLS */}
